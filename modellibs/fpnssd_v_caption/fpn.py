...
class SEBasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, padding=1, reduction=16):
        super(SEBasicBlock, self).__init__()
        self.conv = conv3x3(inplanes, planes, stride, padding)
...
class FPN(nn.Module):
    def __init__(self, block, num_blocks):
        ...
        # # Smooth layers
        # self.smooth1 = SEBasicBlock(256, 256, stride=1, padding=1)
        # self.smooth2 = SEBasicBlock(256, 256, stride=1, padding=1)
        # self.smooth3 = SEBasicBlock(256, 256, stride=1, padding=1)
