...
if __name__=='__main__':
    ...
    for korean_font in korean_font_list:

        image = Image.new('RGB', (img_width, img_height), (255, 255, 255))
        draw = ImageDraw.Draw(image)
        font = ImageFont.truetype(korean_font, size=10)
        ...
        for text in euc_kr:
            ...
            if (start_x + text_size[0]) >= img_width:
                start_x = 0
                start_y += max_font_size

            if (start_y + max_font_size) > img_height:
                image.show(title=korean_font)
                print(korean_font)
                print('debug')
                image = Image.new('RGB', (img_width, img_height), (255, 255, 255))
                draw = ImageDraw.Draw(image)
            ...
            draw.text((start_x, y_computed), text, fill='rgb(0,0,0)', font=font)
    ...
    #     start_x = 0
    #     start_y = 0
    #     for letter_CHO in CHO:
    #
    #         for letter_JOONG in JOONG:
    #
    #             for letter_JONG in JONG:
    #
