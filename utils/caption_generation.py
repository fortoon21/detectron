...
if __name__=='__main__':
    ...
    parser.add_argument("--background_img_path",type=str, default='/media/son/Repository2/V.DO/V_Caption/background')
    parser.add_argument("--image_save_path",    type=str, default='/media/son/Repository2/V.DO/V_Caption/background_result')
    ...
    parser.add_argument("--euc_font_list",      type=list,default=['Jua-Regular.ttf', 'Gaegu-Regular.ttf', 'EastSeaDokdo-Regular.ttf', 'YeonSung-Regular.ttf', 'Sunflower-Bold.ttf', 'Sunflower-Light.ttf',
                                                                   ...
                                                                   'Sunflower-Medium.ttf', 'Gaegu-Light.ttf', 'KirangHaerang-Regular.ttf', 'Gugi-Regular.ttf'])
